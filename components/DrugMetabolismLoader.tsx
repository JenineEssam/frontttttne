...
export default function DrugMetabolismLoader() {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden">
      ...
      {/* Responsive header with warm glow */}
      <motion.div 
        className="absolute top-8 sm:top-16 left-1/2 transform -translate-x-1/2 text-center z-10 px-4"
        initial={{ opacity: 0, y: -40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 2.5, ease: "easeOut" }}
      >
        <motion.h1 
          className="text-amber-900 text-2xl sm:text-4xl tracking-tight mb-2 sm:mb-4"
          animate={{
            textShadow: [
        ...
        <div className="flex items-center justify-center space-x-2 sm:space-x-4">
          ...
          <p className="text-amber-700 text-xs sm:text-sm tracking-wide uppercase">
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* Enhanced atmospheric effects around pill */}
                <motion.div
                  className="absolute inset-0 rounded-full blur-3xl"
                  style={{
                    background: 'radial-gradient(circle, rgba(217, 119, 6, 0.15) 0%, transparent 80%)',
                    width: '150px',
                    height: '150px',
                    left: '50%',
                    top: '50%',
              ...
              >
                <motion.h2 
                  className="text-amber-900 text-xl sm:text-3xl tracking-wide mb-4 sm:mb-6"
                  animate={{
                    textShadow: [
                ...
                <motion.p 
                  className="text-amber-700 text-base sm:text-lg opacity-80"
      ...
      <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-50">
        <div className="flex items-center space-x-3 sm:space-x-6">
          ...
          <motion.div 
            className={`text-xs tracking-wider uppercase ${stage <= 1 ? 'text-amber-600' : 'text-slate-600'}`}
            animate={{ opacity: [0.6, 1, 0.6] }}
            transition={{ duration: 2, repeat: Infinity }}
          >
